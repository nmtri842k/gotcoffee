...
const AboutUs = ({ handleAboutClick, readAboutMore, handleNaturalClick, readNaturalMore }) => {
  const handleClickAboutAll = () => {
    handleAboutClick()
    if (!readAboutMore) {
      toast.warning('Hãy lướt xuống dưới', {
        position: "top-right",
        autoClose: 2000,
    ...
    <div className='app__aboutus app__bg flex__center section__padding' id='about'>
      ...
      <div className="app__aboutus-content">
        <div className="app__aboutus-content_about">
          ...
          <button type='button' className='custom__button' onClick={handleClickAboutAll}>
            {
        ...
        <div className="app__aboutus-content_history">
          ...
          <button type='button' className='custom__button' onClick={handleClickNaturalAll} >
            {
